...
Dieses Home-Assistant-Add-on verwendet eine ntfy-Instanz mit Standardeinstellungen. Weitere Informationen zur Verwendung finden Sie in der [ntfy Dokumentation](https://docs.ntfy.sh/).
